    ...
    <div class="sort-section">
      ...
      <form action="" method="GET" id="sortForm">
        <select name="sort-list" id="sort-list" onchange="document.getElementById('sortForm').submit()">
          ...
          <option value="a-z" <?php if (isset($_GET["sort-list"]) && $_GET["sort-list"] == "a-z") ?>>
            A-Z
          </option>
          <option value="z-a" <?php if (isset($_GET["sort-list"]) && $_GET["sort-list"] == "z-a") ?>>
            Z-A
          </option>
          <option value="date-asc" <?php if (isset($_GET["sort-list"]) && $_GET["sort-list"] == "date-asc") ?>>
            Sort by Date
          </option>
        </select>
      </form>
